...
-- ratch       : ER-101-style boolean. When true, gate cycles inside the step
--                 with period = 2 * gate (ON `gate` pulses, OFF `gate`
--                 pulses, repeat until duration ends). When false, the step
--                 fires once.
