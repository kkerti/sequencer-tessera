...
Scenario.description = "4-track performance demo: polyrhythm + direction + ratchet + swing + scale"
...
function Scenario.build(helpers)
    ...
    -- intro
    Track.setStep(t1, 1, Step.new(36, 115, 2, 1, 1))
    Track.setStep(t1, 2, Step.new(39, 105, 2, 1, 1))
    Track.setStep(t1, 3, Step.new(43, 105, 2, 1, 1))
    Track.setStep(t1, 4, Step.new(46, 100, 2, 1, 1))
    -- groove
    Track.setStep(t1, 5, Step.new(36, 120, 1, 1, 1))
    Track.setStep(t1, 6, Step.new(43, 110, 1, 1, 1))
    Track.setStep(t1, 7, Step.new(46, 110, 1, 1, 1))
    Track.setStep(t1, 8, Step.new(43, 95, 1, 0, 1))
    ...
    Track.setStep(t2, 1, Step.new(60, 95, 2, 1, 1))
    Track.setStep(t2, 2, Step.new(63, 90, 2, 1, 2))
    Track.setStep(t2, 3, Step.new(67, 95, 2, 1, 1))
    Track.setStep(t2, 4, Step.new(70, 90, 2, 1, 3))
    Track.setStep(t2, 5, Step.new(67, 92, 2, 1, 1))
    Track.setStep(t2, 6, Step.new(63, 88, 2, 1, 2))
    Track.setStep(t2, 7, Step.new(60, 95, 2, 1, 1))
    Track.setStep(t2, 8, Step.new(58, 80, 2, 0, 1))
    ...
    Track.setStep(t3, 1, Step.new(48, 88, 4, 2, 1))
    Track.setStep(t3, 2, Step.new(55, 86, 4, 2, 1))
    Track.setStep(t3, 3, Step.new(58, 84, 4, 2, 1))
    Track.setStep(t3, 4, Step.new(60, 82, 4, 2, 1))
    Track.setStep(t3, 5, Step.new(58, 84, 4, 2, 1))
    Track.setStep(t3, 6, Step.new(55, 86, 4, 2, 1))
    ...
    Track.setStep(t4, 1, Step.new(72, 80, 1, 1, 1))
    Track.setStep(t4, 2, Step.new(74, 75, 1, 1, 1))
    Track.setStep(t4, 3, Step.new(77, 70, 1, 1, 1))
    Track.setStep(t4, 4, Step.new(79, 68, 1, 1, 1))
    Track.setStep(t4, 5, Step.new(77, 72, 1, 1, 1))
    Track.setStep(t4, 6, Step.new(74, 76, 1, 1, 1))
    Track.setStep(t4, 7, Step.new(72, 82, 1, 1, 1))
    Track.setStep(t4, 8, Step.new(70, 66, 1, 0, 1))

    math.randomseed(4242)
    MathOps.randomize(t4, "ratchet", 1, 3)
